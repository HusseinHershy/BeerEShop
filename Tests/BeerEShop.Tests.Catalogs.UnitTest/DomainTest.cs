...
namespace BeerEShop.Tests.Catalogs.UnitTest
{
    public class DomainTest
    {
        ...
        public void AbeerIsNecessarilyLinkedToABrewer()
        {
                ...
                Assert.Throws<InvalidOperationException>(() => Beer.Create(BeerModel.Name, BeerModel.BeerStatus, BeerModel.Volume, BeerModel.AlcoholContent, BeerModel.Price, BeerModel.SellingPrice, BeerModel.BreweryId.Value));
        ...
        public void AbeerIsLinked()
        {
            ...
            Beer Result = Beer.Create(BeerModel.Name, BeerModel.BeerStatus, BeerModel.Volume, BeerModel.AlcoholContent, BeerModel.Price, BeerModel.SellingPrice, BeerModel.BreweryId.Value);
        ...
        public void ABrewerBrewsOneToSeveralBeers()
        {
           ...
           var FirstBeer =  Beer.Create("Leffe Blonde", BeerStatus.Available, 5.2m, 100, 115, 130, 1);
            var SecondBeer = Beer.Create("Imperial Enchanted Rain Rocket", BeerStatus.Available, 6.6m, 70, 80, 130, 1);
